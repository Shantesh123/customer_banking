...
def main():
    ...
    savings_maturity = float(input('Enter your months for account held: '))
    ...
    cd_maturity = float(input('Enter your months for account held: '))
    ...
    # ADD YOUR CODE HERE
    print('Your interest earned  is $', format(interest_earned, ',.2f'))
    print('Your updated balance is $', format(updated_cd_balance, ',.2f'))
